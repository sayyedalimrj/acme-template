...
export const onboardingRequests: OnboardingRequest[] = [
  ...
  },
  {
    ...
    contactNote: 'مطمئن نیستیم فروشگاه آنلاین ما چطور کار می‌کند؛ به بررسی و راهنمایی نیاز داریم.',
    ...
    statusHistory: [
      ...
      { status: 'under_review', date: '2026-06-06T10:00:00Z' },
      {
        ...
        note: 'لطفاً وضعیت فعلی فروشگاه آنلاین خود را تأیید کنید (بدون نیاز به ورود اطلاعات حساس در برنامه).',
      },
    ],
