 ...
 *
 * Used for the prominent "Add product" / "Add customer" affordances the merchant expects on
 * list screens. Real creation is not wired yet, so pressing it reveals a small, honest
 * "coming soon" caption instead of performing an action. Soft blue pill, short label, RTL-safe.
 */
