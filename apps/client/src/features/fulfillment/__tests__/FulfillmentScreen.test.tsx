...
describe('FulfillmentScreen', () => {
  it('renders orders needing fulfillment', async () => {
    renderWithProviders(<FulfillmentScreen />);
    // A processing/unfulfilled order from the mock data appears in the queue.
