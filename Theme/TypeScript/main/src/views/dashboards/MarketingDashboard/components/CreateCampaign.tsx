...
const audienceGroupOption = [
    { label: 'مشتریان فعلی', value: 'existingCustomer' },
    { label: 'علاقه‌مندان به فناوری', value: 'techEnthusiasts' },
    { label: 'دانش‌آموزان و والدین', value: 'studentsParents' },
    { label: 'عموم مردم', value: 'generalPublic' },
    { label: 'خریداران هدیه', value: 'giftShoppers' },
]

const validationSchema = z.object({
    name: z.string().min(1, 'لطفاً نام کمپین را وارد کنید'),
    startDate: z.number().min(1, 'لطفاً تاریخ شروع را انتخاب کنید'),
    endDate: z.number().min(1, 'لطفاً تاریخ پایان را انتخاب کنید'),
    budget: z.number().min(1, 'لطفاً بودجه را وارد کنید'),
    campaignType: z.string().min(1, 'لطفاً نوع کمپین را انتخاب کنید'),
    audienceGroup: z
        .array(z.object({ value: z.string(), label: z.string() }))
        .nonempty('حداقل یک مورد باید انتخاب شود!'),
})
