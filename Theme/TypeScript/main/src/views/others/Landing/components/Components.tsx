                ...
                <div className="grid grid-cols-1 lg:grid-cols-8 gap-4">
                    ...
                    >
                        <motion.h2 className="mb-8 max-w-[650px] leading-[1.3] text-5xl">
                            کاوش در مجموعه غنی از کامپوننت‌های UI
                        </motion.h2>
                        <motion.p className="max-w-[600px]">
                            هر کامپوننت با استفاده از
                            TailwindCSS با دقت طراحی شده است، که باعث می‌شود انعطاف‌پذیر، قابل سفارشی‌سازی، و
                            آسان برای ادغام در پروژه با حداقل تنظیمات باشد.
                        </motion.p>
                    </motion.div>
