            ...
            <Container>
                ...
                >
                    ...
                    <motion.p className="mx-auto max-w-[600px]">
                        برای عملکرد، مقیاس‌پذیری، و سهولت استفاده طراحی شده است—تجربه یک قالب را که همه نیازهای پروژه شما را برآورده می‌کند، تجربه کنید
                    </motion.p>
                </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        به آسانی بین حالت‌های روشن و تاریک یا ایجاد تم سفارشی خود، جابجا شوید.
                                    </p>
                                </div>
                            </Card>
                            <Card
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        راهنماهای گام به گام تفصیلی برای کمک به شما در شروع کار و تسلط بر قالب.
                                    </p>
                                </div>
                            </Card>
                        </div>
                        <div className="mt-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        از گزینه‌های چیدمان مختلف برای مطابقت با نیازهای شما انتخاب کنید. چه چیدمان عمودی، افقی، یا راست به چپ (RTL) باشد، ما برای هر سبک طراحی یا زبان انعطاف‌پذیری فراهم می‌کنیم.
                                    </p>
                                </div>
                            </Card>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <div className="flex flex-col justify-between h-full">
                                ...
                                <div className="mt-6">
                                    <h4 className="font-bold">
                                        کامپوننت‌های Tailwind دست‌ساز
                                    </h4>
                                    <p className="mt-2">
                                        مجموعه‌ای از کامپوننت‌های Tailwind سفارشی، بسیار انعطاف‌پذیر که برای هر مورد استفاده مناسب هستند.
                                    </p>
                                </div>
                            </div>
                        </Card>
